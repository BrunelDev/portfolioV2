  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between px-4 sm:px-14 mt-20">
        <div className="w-full sm:w-[30%] rounded-full">
          <Image src={"/moi.png"} width={400} height={400} alt="server image" className="rounded-full border-4 border-lime-600 mx-auto sm:mx-0"/>
        </div>
